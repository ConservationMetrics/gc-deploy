...
class BootstrapScreen(Screen):
    ...
    def compose(self) -> ComposeResult:
        ...
        with Vertical(id="form"):
            yield Static(
                "Enter your Auth0 tenant domain and the bootstrap Machine-to-Machine "
                "application's credentials.\n"
                "Create this M2M app once -- see auth0/README.md's "
                "'Bootstrap M2M application for the wizard' section."
            )
            ...
            yield Input(placeholder="client id", id="m2m_client_id")
            yield Label("M2M client secret")
            yield Input(
                placeholder="client secret", password=True, id="m2m_client_secret"
            )
    ...
    def on_button_pressed(self, event: Button.Pressed) -> None:
        ...
        self.app.wizard_data.update(
            ...
            m2m_client_id=self.query_one("#m2m_client_id", Input).value.strip(),
            m2m_client_secret=self.query_one("#m2m_client_secret", Input).value.strip(),
        )
    ...
    def _run(self) -> None:
        ...
        try:
            run_wizard(
                ...
                domain=data["domain"],
                m2m_client_id=data["m2m_client_id"],
                m2m_client_secret=data["m2m_client_secret"],
