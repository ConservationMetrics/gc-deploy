...
5. Create a M2M application for metrics with a name like **GC Metrics**, and grant `read:users` and `read:stats` scopes to it. This lets the GC Metrics app read statistics from auth0 about other apps.
